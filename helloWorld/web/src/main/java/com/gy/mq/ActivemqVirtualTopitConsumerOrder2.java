 ...
 */
public class ActivemqVirtualTopitConsumerOrder2 implements MessageListener {
    private String name = "";
    private Connection connection = null;
    private Session session = null;
    private MessageConsumer consumer = null;
    ActivemqVirtualTopitConsumerOrder2(String name){
        this.name=name;
    }

    public ActivemqVirtualTopitConsumerOrder2(){}
    ...
    public static void main(String[] args) {
        ActivemqVirtualTopitConsumerOrder2 activemqVirtualTopitConsumerOrder2 = new ActivemqVirtualTopitConsumerOrder2();
        try {
            activemqVirtualTopitConsumerOrder2.initialize();
            activemqVirtualTopitConsumerOrder2.recive();
        } catch (JMSException e) {
            e.printStackTrace();
        }
